...
function recalculate() {
  ...
  const badgeLabel = $("rBadgeLabel");
  const badgeYears = $("rBadgeYears");

  badge.classList.remove("hidden");
  if (seniority >= 3) {
    badgeIcon.className = "w-14 h-14 rounded-full flex items-center justify-center mx-auto bg-yellow-50 text-yellow-500";
    badgeLabel.className = "text-[9px] font-black uppercase tracking-wider mt-1 text-yellow-600";
    badgeLabel.textContent = "Oro";
    badgeYears.textContent = `${seniority} años`;
  } else if (seniority === 2) {
    badgeIcon.className = "w-14 h-14 rounded-full flex items-center justify-center mx-auto bg-slate-100 text-slate-400";
    badgeLabel.className = "text-[9px] font-black uppercase tracking-wider mt-1 text-slate-500";
    badgeLabel.textContent = "Plata";
    badgeYears.textContent = "2 años";
  } else {
    badgeIcon.className = "w-14 h-14 rounded-full flex items-center justify-center mx-auto bg-orange-50 text-orange-400";
    badgeLabel.className = "text-[9px] font-black uppercase tracking-wider mt-1 text-orange-500";
    badgeLabel.textContent = seniority === 1 ? "Bronce" : "Nuevo";
    badgeYears.textContent = seniority === 1 ? "1 año" : "Nuevo ingreso";
  }
